...
def log_whatsapp_reply_processing(
    *,
    phone_digits: str,
    ...
    """Structured log after normalization + Lead update (or skip)."""
    record: dict[str, Any] = {
        "event": "whatsapp_reply_processed",
        "timestamp_utc": _now_iso(),
        "phone_digits": str(phone_digits or ""),
        "raw_message_preview": (raw_message_preview or "")[:8000],
